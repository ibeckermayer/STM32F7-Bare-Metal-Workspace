...
#define AHB1PERIPH_BASE_SELF (PERIPH_BASE + AHB1_OFFSET)

#define RCC_OFFSET 0x3800UL
#define RCC_BASE_SELF (AHB1PERIPH_BASE_SELF + RCC_OFFSET)
#define RCC_AHB1ENR_GPIOBEN (1UL << 1)

#define GPIOB_OFFSET 0x0400UL
#define GPIOB_BASE_BASE (AHB1PERIPH_BASE_SELF + GPIOB_OFFSET)
...
#define RCC_SELF ((RCC_TypeDef_SELF *)RCC_BASE_SELF)
#define GPIOB_SELF ((GPIO_TypeDef_SELF *)GPIOB_BASE_BASE)

int main()
{
  /* Enable clock access to port B */
  RCC_SELF->AHB1ENR |= RCC_AHB1ENR_GPIOBEN;

  /* Set PB0, PB7, and PB14 to output mode */
  GPIOB_SELF->MODER |= LEDS_MODER;
  ...
  while (1)
  {
    ...
    GPIOB_SELF->ODR ^= USER_LED_1 | USER_LED_2 | USER_LED_3;
